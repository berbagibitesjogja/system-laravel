                ...
                <tbody>
                    @foreach ($foods as $item)
                        <tr class="odd:bg-white even:bg-gray-50 border-b">
                            <th scope="row"
                                class="text-center md:text-left px-2 py-4 font-medium text-gray-900 whitespace-nowrap w-5/12">
                                {{ $item->name }}
                                @if ($item->notes)
                                    <p class="hidden sm:table-cell text-xs font-light text-wrap">
                                        *{{ $item->notes }}
                                    </p>
                                @endif
