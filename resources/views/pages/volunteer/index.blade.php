    ...
    <div x-data="{ search: '', showDeleteModal: false, deleteUrl: '' }">
        <div class="flex flex-wrap gap-4 items-center justify-between mb-8">
            <div class="flex flex-wrap gap-3 items-center">
                ...
                @if (auth()->user()->role == 'super' || auth()->user()->division->name == 'Friend')
        ...
        <x-table>
            ...
            <x-slot:body>
                        ...
                        @if (auth()->user()->role == 'super' || auth()->user()->division->name == 'Friend')
                            <x-td class="hidden sm:table-cell">
                                <div class="flex justify-center gap-2">
                                    ...
                                    @if (auth()->user()->role == 'super')
                                    <x-btn type="button" variant="danger" class="!p-2" @click="deleteUrl = '{{ route('volunteer.destroy', $item->id) }}'; showDeleteModal = true">
                ...
                @empty
                    <x-tr>
                        <x-td colspan="4" class="py-12 text-center text-navy-400 font-medium">
        ...
        <x-modal 
            ...
            message="Apakah Anda yakin ingin menghapus data volunteer ini? Tindakan ini tidak dapat dibatalkan."
